...
4. **Issue Identified During Runtime Connection Establishment**
   The failure was encountered only during runtime MQ session establishment initiated from the Montran Gateway side. Since offline connectivity validation was not feasible, the issue could not be detected earlier in the testing lifecycle.
